...
namespace Lab10
{
    class ResearchTeamCollection
    {
        ...
        public void SortRegNumber() => researchTeams.Sort((x, y) => x.Team.CompareTo(y.Team));
        public void SortThemeName() => researchTeams.Sort(new ResearchTeam());
        public void SortPapers() => researchTeams.Sort(new ResearchTeamComparer());
